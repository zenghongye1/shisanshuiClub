...
set SourcePath=G:\dstars\chess_u3d\yxhy_game_base\App_Res\app_4
cd %AssetPath%
...
::---------------------------------------------------
::第四步，将有些配置文件拷贝到StreamAsset目录下
::---------------------------------------------------
del /f/q/s %AssetPath%\StreamingAssets\config\app_config.txt
xcopy %SourcePath%\app_config.txt %AssetPath%\StreamingAssets\config
pause
