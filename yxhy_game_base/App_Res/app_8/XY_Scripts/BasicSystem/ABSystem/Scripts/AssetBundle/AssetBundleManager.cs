...
namespace XYHY.ABSystem
{
    ...
    public class AssetBundleManager : MonoBehaviour
    {
        ...
        public void Init(List<string> depFileNameLst, Action callback)
        {
        ...
        IEnumerator LoadDepInfo(string depFileName)
        {
        ...
        public IEnumerator SubLoadDepInfo(string dependFileName)
        {
