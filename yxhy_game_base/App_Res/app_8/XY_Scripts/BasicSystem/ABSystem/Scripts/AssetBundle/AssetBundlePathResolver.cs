...
namespace XYHY.ABSystem
{
    ...
    public class AssetBundlePathResolver
    {
        ...
        //版本文件存放文件名
        public virtual string VerCommSaveFile { get { return "ver_app_8.txt"; } }
        public virtual string VerGame11SaveFile { get { return "ver_game_25.txt"; } }
        public virtual string VerGame18SaveFile { get { return "ver_game_18.txt"; } }
...
#elif UNITY_IOS
            if (forWWW)
                filePath = string.Format("file://{0}/Raw/{1}/{2}", Application.dataPath, BundlePlatformStr + "/" + BundleSaveDirName, path);
            else
                filePath = string.Format("{0}/Raw/{1}/{2}", Application.dataPath, BundlePlatformStr + "/" + BundleSaveDirName, path);
#else
        ...
        /// AB 依赖信息文件名
        /// </summary>
        public virtual string DependCommFileName { get { return "dep_app_8.all"; } }
        public virtual string DependGame11FileName { get { return "dep_game_25.all"; } }
        public virtual string DependGame18FileName { get { return "dep_game_18.all"; } }
