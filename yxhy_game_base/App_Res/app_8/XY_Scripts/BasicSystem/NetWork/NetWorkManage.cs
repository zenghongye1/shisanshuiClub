    ...
    public void Init()
    {
        ...
        switch(EServerUrlType)
        {
            case ServerUrlType.DEVELOP_URL:
                m_BaseUrl = "http://intest.dstars.cc/dstars_4/api/flashapi.php";
                break;
            case ServerUrlType.INTEST_URL:
                m_BaseUrl = "http://intest.dstars.cc/dstars/api/api.php";
                break;
            case ServerUrlType.RELEASE_URL:
                m_BaseUrl = "http://ysqp.zdgame.com/dstars/api/api.php";
                break;
            case ServerUrlType.TSET_URL:
                m_BaseUrl = "http://test.dstars.cc/dstars_4/api/flashapi.php";
                break;
        }
    }
        ...
        HTTPRequest request = new HTTPRequest(new Uri(url), (req, resp) =>
        {
            ...
            {                
                if (resp.IsSuccess)
                {
                    ...
                    if (callBack !=null)
                    {
                        callBack(resp.StatusCode, context);
                    }
                }
                else
                {
