...
public class Spine_SkeletonWrap
{
	...
	static int _CreateSpine_Skeleton(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				Spine.SkeletonData arg0 = (Spine.SkeletonData)ToLua.CheckObject(L, 1, typeof(Spine.SkeletonData));
	...
	static int UpdateCache(IntPtr L)
	{
		try
		{
			...
			Spine.Skeleton obj = (Spine.Skeleton)ToLua.CheckObject(L, 1, typeof(Spine.Skeleton));
			obj.UpdateCache();
			return 0;
		}
		catch(Exception e)
	...
	static int SetSkin(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(Spine.Skeleton), typeof(Spine.Skin)))
			{
				Spine.Skeleton obj = (Spine.Skeleton)ToLua.ToObject(L, 1);
				Spine.Skin arg0 = (Spine.Skin)ToLua.ToObject(L, 2);
				obj.SetSkin(arg0);
				return 0;
			}
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(Spine.Skeleton), typeof(string)))
			{
				Spine.Skeleton obj = (Spine.Skeleton)ToLua.ToObject(L, 1);
	...
	static int GetAttachment(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(Spine.Skeleton), typeof(int), typeof(string)))
			{
				Spine.Skeleton obj = (Spine.Skeleton)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(Spine.Skeleton), typeof(string), typeof(string)))
			{
				Spine.Skeleton obj = (Spine.Skeleton)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				string arg1 = ToLua.ToString(L, 3);
	...
	static int get_UpdateCacheList(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index UpdateCacheList on a nil value" : e.Message);
		}
	}
	...
	static int get_DrawOrder(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index DrawOrder on a nil value" : e.Message);
		}
	}
	...
	static int get_IkConstraints(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index IkConstraints on a nil value" : e.Message);
		}
	}
	...
	static int get_PathConstraints(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index PathConstraints on a nil value" : e.Message);
		}
	}
	...
	static int get_TransformConstraints(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index TransformConstraints on a nil value" : e.Message);
		}
	}
	...
	static int get_Skin(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index Skin on a nil value" : e.Message);
		}
	}
	...
	static int set_Skin(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Spine.Skeleton obj = (Spine.Skeleton)o;
			Spine.Skin arg0 = (Spine.Skin)ToLua.CheckObject(L, 2, typeof(Spine.Skin));
			obj.Skin = arg0;
			return 0;
		}
		catch(Exception e)
