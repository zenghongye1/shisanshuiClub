...
public class UIGridWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("scaleInactive", get_scaleInactive, set_scaleInactive);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_scaleInactive(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIGrid obj = (UIGrid)o;
			bool ret = obj.scaleInactive;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index scaleInactive on a nil value" : e.Message);
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_scaleInactive(IntPtr L)
	{
		object o = null;
