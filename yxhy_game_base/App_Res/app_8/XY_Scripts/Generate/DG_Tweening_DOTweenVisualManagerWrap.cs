...
public class DG_Tweening_DOTweenVisualManagerWrap
{
	...
	static int get_preset(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index preset on a nil value" : e.Message);
		}
	}
	...
	static int get_onEnableBehaviour(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index onEnableBehaviour on a nil value" : e.Message);
		}
	}
	...
	static int get_onDisableBehaviour(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index onDisableBehaviour on a nil value" : e.Message);
		}
	}
