...
namespace BestHTTP
{
    ...
    internal abstract class ConnectionBase : IDisposable
    {
        ...
        internal void HandleCallback()
        {
            try
            {
                HTTPManager.Logger.Information("ConnectionBase", "To HandleProgressCallback===========================");
                HandleProgressCallback();
                HTTPManager.Logger.Information("ConnectionBase", "End HandleProgressCallback, state={0}===================="+ State);
