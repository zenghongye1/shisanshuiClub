        ...
        public void DecodeWithExtensions(WebSocket webSocket)
        {
            ...
            if (this.Type == WebSocketFrameTypes.Text && this.Data != null)
            {
                if(Data[0] == '@')
                {
                    ...
                    Buffer.BlockCopy(Data, 1, Data, 0, Data.Length - 1);
                    Data = QuickLZ.decompress(Data);
                    //UnityEngine.Debug.LogError(System.Text.Encoding.UTF8.GetString(Data));
                    //UnityEngine.Debug.LogError(System.Text.Encoding.Default);
                }
