...
public class UIGrid : UIWidgetContainer
{
    ...
    public bool scaleInactive = false;
	...
	public List<Transform> GetChildList ()
	{
		...
		for (int i = 0; i < myTrans.childCount; ++i)
		{
            ...
            {
                if (!scaleInactive || (t && t.localScale == Vector3.one)|| (t && t.localScale == new Vector3(0.74f,0.74f,0.74f)))
                    list.Add(t);
            }
		}
	...
	protected virtual void ResetPosition (List<Transform> list)
	{
		...
		if (pivot != UIWidget.Pivot.TopLeft)
		{
			...
			{
				Transform t = myTrans.GetChild(i);
                if (!scaleInactive ||t.localScale==Vector3.one ||t.localScale==new Vector3(0.74f,0.74f,0.74f))
                {
