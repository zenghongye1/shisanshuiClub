...
public class UIPanel : UIRect
{
	...
	public bool affectByParentShowHide = true;
	public bool shouldShowHideAffectColliders = true;
    ...
    public bool FastHide { get { return fastHideFlag; } }
    ...
    List<UIEffect> effectLst = new List<UIEffect>();
    public void AddUIEffect(UIEffect uieffect)
    {
        if (effectLst.Contains(uieffect))
        {
            return;
        }
        effectLst.Add(uieffect);
    }

    public void RemoveUIEffect(UIEffect uieffect)
    {
        effectLst.Remove(uieffect);
    }

    public int UpdateUIEffect()
    {
        int rq = 0;
        for (int i = 0; i < effectLst.Count; i++)
        {
            rq += effectLst[i].UpdateEffectUI();            
        }
        return rq;
    }
    ...
    private List<BoxCollider> lastDisabledBoxColliders = new List<BoxCollider>();
    public void SetBoxCollidersEnable(bool value)
    {
        if (!shouldShowHideAffectColliders)
        {
            return;
        }
