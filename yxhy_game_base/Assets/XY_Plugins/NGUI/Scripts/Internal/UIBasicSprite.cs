...
#region Fill Functions
	...
	protected void Fill (BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols, Rect outer, Rect inner)
	{
        ...
        switch (type)
        {
            ...
            case Type.Quarter:
                mOuterUV.xMax = mOuterUV.xMax - 1f / tex.width;
                mOuterUV.yMin = mOuterUV.yMin + 1f / tex.width;
                mInnerUV.xMax = mInnerUV.xMax - 1f / tex.width;
                mInnerUV.yMin = mInnerUV.yMin + 1f / tex.width;
    ...
    /// <summary>
    /// Quarter sprite fill function.
    /// </summary>
    void QuarterFill(BetterList<Vector3> verts,BetterList<Vector2> uvs,BetterList<Color32> cols)
    {
        Vector4 v = drawingDimensions;
        Vector4 u = drawingUVs;
        Color32 c = drawingColor;
    ...
    /// <summary>
    /// Half sprite fill function.
    /// </summary>

    void Y_Sym_Fill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
    {
        Vector4 v = drawingDimensions;
        Vector4 u = drawingUVs;
        Color32 c = drawingColor;
    ...
    void X_Sym_Fill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
    {
        Vector4 v = drawingDimensions;
        Vector4 u = drawingUVs;
        Color32 c = drawingColor;
    ...
    void SlicedQuarterFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
    {
        Vector4 br = border * pixelSize;
    ...
    void Sliced_Y_Sym_Fill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
    {
        Vector4 br = border * pixelSize;
    ...
    void Sliced_X_Sym_Fill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
    {
        Vector4 br = border * pixelSize;
