...
public class UniWebViewPlugin {
    ...
    [DllImport("UniWebView")]
    private static extern void _UniWebViewInit(string name, int top, int left, int bottom, int right, int screenWidth, int screenHeight, bool isPortrait);
    [DllImport("UniWebView")]
    ...
    public static void Init(string name, int top, int left, int bottom, int right, bool isPortrait) {
        if (Application.platform == RuntimePlatform.OSXEditor) {
            ...
            _UniWebViewInit(name, top, left, bottom, right, Screen.width, Screen.height, isPortrait);
        } else {
