...
public class UniWebViewPlugin {
    ...
    private static extern void _UniWebViewInit(string name, int top, int left, int bottom, int right, bool isPortrait);
    [DllImport("__Internal")]
    ...
    public static void Init(string name, int top, int left, int bottom, int right, bool isPortrait) {
        if (Application.platform == RuntimePlatform.IPhonePlayer) {
            _UniWebViewInit(name, top, left, bottom, right, isPortrait);
        }
    }
