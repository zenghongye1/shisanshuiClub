...
// 	static void		Check072(CMJFanCounter* pCounter);	// 七星不靠
	...
	static void		Check080(CMJFanCounter* pCounter);	// 松原夹胡
	static void		Check081(CMJFanCounter* pCounter);	// 对宝

	static void		Check082(CMJFanCounter* pCounter);	// 三清,胡的人开门了，其他3家没有开门
	static void		Check083(CMJFanCounter* pCounter);	// 四清,胡牌时，四家都没有开门
	static void		Check084(CMJFanCounter* pCounter);	// 三清夹五,三家门清，胡的牌正好是5时

	static void		Check085(CMJFanCounter* pCounter);	// 摸宝
