...
namespace XYHY.ABSystem
{
    public class AssetBundleInfo
    {
        ...
        public virtual void Dispose()
        {
            ...
            //AssetBundleManager.Instance.UnloadUnusedBundle();
...
#if UNITY_EDITOR
                ResetShader(_mainObject);
#endif
                return _mainObject;
            }
        }

        void ResetShader(Object obj)
        {
            ...
            //{
            //    var renders = (obj as GameObject).GetComponentsInChildren<Renderer>();
            //    for(int i = 0; i < renders.Length; i++)
            //    {
            //        if(renders[i].sharedMaterial != null )
            //            renders[i].sharedMaterial.shader = Shader.Find(renders[i].sharedMaterial.shader.name);
            //    }
            //}
        }
        void UnloadBundle()
