...
public class UnityEngine_FontWrap
{
	...
	static int RequestCharactersInTexture(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Font), typeof(string)))
			{
				UnityEngine.Font obj = (UnityEngine.Font)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				obj.RequestCharactersInTexture(arg0);
				return 0;
			}
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Font), typeof(string), typeof(int)))
			{
				UnityEngine.Font obj = (UnityEngine.Font)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Font), typeof(string), typeof(int), typeof(UnityEngine.FontStyle)))
			{
				UnityEngine.Font obj = (UnityEngine.Font)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
				UnityEngine.FontStyle arg2 = (UnityEngine.FontStyle)ToLua.ToObject(L, 4);
	...
	static int GetCharacterInfo(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Font), typeof(char), typeof(LuaInterface.LuaOut<UnityEngine.CharacterInfo>)))
			{
				UnityEngine.Font obj = (UnityEngine.Font)ToLua.ToObject(L, 1);
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Font), typeof(char), typeof(LuaInterface.LuaOut<UnityEngine.CharacterInfo>), typeof(int)))
			{
				UnityEngine.Font obj = (UnityEngine.Font)ToLua.ToObject(L, 1);
				char arg0 = (char)LuaDLL.lua_tonumber(L, 2);
				UnityEngine.CharacterInfo arg1;
			...
			else if (count == 5 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Font), typeof(char), typeof(LuaInterface.LuaOut<UnityEngine.CharacterInfo>), typeof(int), typeof(UnityEngine.FontStyle)))
			{
				UnityEngine.Font obj = (UnityEngine.Font)ToLua.ToObject(L, 1);
				char arg0 = (char)LuaDLL.lua_tonumber(L, 2);
				UnityEngine.CharacterInfo arg1;
				int arg2 = (int)LuaDLL.lua_tonumber(L, 4);
				UnityEngine.FontStyle arg3 = (UnityEngine.FontStyle)ToLua.ToObject(L, 5);
	...
	static int get_fontNames(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index fontNames on a nil value" : e.Message);
		}
	}
	...
	static int get_dynamic(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index dynamic on a nil value" : e.Message);
		}
	}
	...
	static int get_ascent(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index ascent on a nil value" : e.Message);
		}
	}
	...
	static int get_lineHeight(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index lineHeight on a nil value" : e.Message);
		}
	}
	...
	{
		ToLua.Push(L, new EventObject("UnityEngine.Font.textureRebuilt"));
		return 1;
	}
	...
	static int set_characterInfo(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Font obj = (UnityEngine.Font)o;
			UnityEngine.CharacterInfo[] arg0 = ToLua.CheckObjectArray<UnityEngine.CharacterInfo>(L, 2);
