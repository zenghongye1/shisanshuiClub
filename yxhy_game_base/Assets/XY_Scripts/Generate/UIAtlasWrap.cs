...
public class UIAtlasWrap
{
	...
	static int GetListOfSprites(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(UIAtlas)))
			{
				UIAtlas obj = (UIAtlas)ToLua.ToObject(L, 1);
				BetterList<string> o = obj.GetListOfSprites();
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UIAtlas), typeof(string)))
			{
				UIAtlas obj = (UIAtlas)ToLua.ToObject(L, 1);
	...
	static int CheckIfRelated(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 2);
			UIAtlas arg0 = (UIAtlas)ToLua.CheckUnityObject(L, 1, typeof(UIAtlas));
	...
	static int get_spriteMaterial(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index spriteMaterial on a nil value" : e.Message);
		}
	}
	...
	static int get_spriteList(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index spriteList on a nil value" : e.Message);
		}
	}
