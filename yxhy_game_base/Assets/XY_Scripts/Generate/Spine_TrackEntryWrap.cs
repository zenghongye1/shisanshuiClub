...
public class Spine_TrackEntryWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("AnimationEnd", get_AnimationEnd, null);
	...
	static int get_TrackIndex(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index TrackIndex on a nil value" : e.Message);
		}
	}
	...
	static int get_TrackTime(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index TrackTime on a nil value" : e.Message);
		}
	}
	...
	static int get_TrackEnd(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index TrackEnd on a nil value" : e.Message);
		}
	}
	...
	static int get_AnimationStart(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index AnimationStart on a nil value" : e.Message);
		}
	}
	...
	static int get_AnimationEnd(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index AnimationEnd on a nil value" : e.Message);
		}
	}
	...
	static int get_AnimationLast(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index AnimationLast on a nil value" : e.Message);
		}
	}
	...
	static int get_EventThreshold(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index EventThreshold on a nil value" : e.Message);
		}
	}
	...
	static int get_AttachmentThreshold(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index AttachmentThreshold on a nil value" : e.Message);
		}
	}
	...
	static int get_DrawOrderThreshold(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index DrawOrderThreshold on a nil value" : e.Message);
		}
	}
	...
	static int get_MixTime(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index MixTime on a nil value" : e.Message);
		}
	}
	...
	static int get_MixDuration(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index MixDuration on a nil value" : e.Message);
		}
	}
	...
	static int get_MixingFrom(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index MixingFrom on a nil value" : e.Message);
		}
	}
	...
	{
		ToLua.Push(L, new EventObject("Spine.TrackEntry.Start"));
		return 1;
	}
	...
	{
		ToLua.Push(L, new EventObject("Spine.TrackEntry.Interrupt"));
		return 1;
	}
	...
	{
		ToLua.Push(L, new EventObject("Spine.TrackEntry.End"));
		return 1;
	}
	...
	{
		ToLua.Push(L, new EventObject("Spine.TrackEntry.Dispose"));
		return 1;
	}
	...
	{
		ToLua.Push(L, new EventObject("Spine.TrackEntry.Complete"));
		return 1;
	}
	...
	{
		ToLua.Push(L, new EventObject("Spine.TrackEntry.Event"));
		return 1;
	}
	...
	static int set_Start(IntPtr L)
	{
		try
		{
			...
			{
				Spine.AnimationState.TrackEntryDelegate ev = (Spine.AnimationState.TrackEntryDelegate)LuaMisc.GetEventHandler(obj, typeof(Spine.TrackEntry), "Start");
	...
	static int set_End(IntPtr L)
	{
		try
		{
			...
			{
				Spine.AnimationState.TrackEntryDelegate ev = (Spine.AnimationState.TrackEntryDelegate)LuaMisc.GetEventHandler(obj, typeof(Spine.TrackEntry), "End");
				Delegate[] ds = ev.GetInvocationList();
				LuaState state = LuaState.Get(L);
	...
	static int set_Complete(IntPtr L)
	{
		try
		{
			...
			{
				Spine.AnimationState.TrackEntryDelegate ev = (Spine.AnimationState.TrackEntryDelegate)LuaMisc.GetEventHandler(obj, typeof(Spine.TrackEntry), "Complete");
				Delegate[] ds = ev.GetInvocationList();
				LuaState state = LuaState.Get(L);
	...
	static int set_Event(IntPtr L)
	{
		try
		{
			...
			{
				Spine.AnimationState.TrackEntryEventDelegate ev = (Spine.AnimationState.TrackEntryEventDelegate)LuaMisc.GetEventHandler(obj, typeof(Spine.TrackEntry), "Event");
				Delegate[] ds = ev.GetInvocationList();
				LuaState state = LuaState.Get(L);
