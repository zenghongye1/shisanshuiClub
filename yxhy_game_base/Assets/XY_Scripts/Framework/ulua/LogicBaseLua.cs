...
//    private LuaFunction m_onFingerDownFunc;
 ...
 //   private LuaFunction m_onDragFunc;
 ...
 //       m_onFingerSwipeFunc = luaState.GetFunction(m_luaClassName + ".OnSwipe", false);
   ...
   //     m_onDragFunc = luaState.GetFunction(m_luaClassName + ".OnDrag", false);
    }
    ...
    //        {
    //            m_onDragFunc.BeginPCall();
    //            m_onDragFunc.Push(self);
    //            m_onDragFunc.Push(gesture.DeltaMove);

    //            m_onDragFunc.Push(normalizedTime);
    //            m_onDragFunc.PCall();
    //            m_onDragFunc.EndPCall();
    //        }
    //    }
    //   catch(Exception e)
    //    {
