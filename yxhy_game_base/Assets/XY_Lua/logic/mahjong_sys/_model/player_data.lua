...
this.localtionData = {}
this.localtionData.latitude = 0.0
this.localtionData.longitude = 0.0
--[[--
 * @Description: 
...
function this.SetCoinGidTbl(tt)
    coinGidTable=tt
end
--[[--
 * @Description: 设置重连参数  
...
function this.GetClientGameId()
	return GameUtil.GetResId(sessionData["_gid"])
end
