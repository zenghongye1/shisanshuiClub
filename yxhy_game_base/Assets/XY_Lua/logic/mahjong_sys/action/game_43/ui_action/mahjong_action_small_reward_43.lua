...
local mahjong_action_small_reward_43 = class("mahjong_action_small_reward_43", base)


function mahjong_action_small_reward_43:GetPlayerMoreInfo(playerInfo,rewards,win_type,win_viewSeat,viewSeat,isBanker)
 	playerInfo.difen = "5底"
...
function mahjong_action_small_reward_43:GetScoreItem(rewards,win_type,win_viewSeat,viewSeat)
	local scoreItem = {}
	...
	if rewards.lianZhuangFan>0 then
 	...
 	if rewards.three_score ~= 0 then
 		local item12 = {}
 		item12.des = "开局三连碰分"
 		item12.num = ""..rewards.three_score.."分"
 		table.insert(scoreItem,item12)
 	end
...
return mahjong_action_small_reward_43