...
local mahjong_action_small_reward_83 = class("mahjong_action_small_reward_83", base)

function mahjong_action_small_reward_83:GetScoreItem(rewards,win_type,win_viewSeat,viewSeat, i, who_win,base,bGangAddNoWin,banker)
...
return mahjong_action_small_reward_83