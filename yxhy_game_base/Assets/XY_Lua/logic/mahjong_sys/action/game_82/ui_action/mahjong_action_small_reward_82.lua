...
local mahjong_action_small_reward_82 = class("mahjong_action_small_reward_82", base)

function mahjong_action_small_reward_82:GetScoreItem(rewards,win_type,win_viewSeat,viewSeat, i, who_win,base,bGangAddNoWin,banker)
...
function mahjong_action_small_reward_82:CheckIsBank(win_type,who_win,i,rewards,banker) 
...
return mahjong_action_small_reward_82