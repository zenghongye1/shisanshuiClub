...
local mahjong_action_small_reward_84 = class("mahjong_action_small_reward_84", base)

function mahjong_action_small_reward_84:GetScoreItem(rewards,win_type,win_viewSeat,viewSeat, i, who_win,base,bGangAddNoWin,banker)
	...
	------------------------------------------跑分结算-----------------------------------------------
	if rewards[i].xiapao_score then
		local item_pao = {}
 		item_pao.des = "跑分"..rewards[i].xiapao_score.."分"
...
function mahjong_action_small_reward_84:CheckIsBank(win_type,who_win,i,rewards,banker) 
...
return mahjong_action_small_reward_84