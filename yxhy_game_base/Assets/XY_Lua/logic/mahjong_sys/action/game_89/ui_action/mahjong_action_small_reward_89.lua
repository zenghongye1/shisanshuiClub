...
local mahjong_action_small_reward_89 = class("mahjong_action_small_reward_89", base)

function mahjong_action_small_reward_89:GetScoreItem(rewards,win_type,win_viewSeat,viewSeat, i, who_win,base,bGangAddNoWin,banker)
...
function mahjong_action_small_reward_89:CheckIsBank(win_type,who_win,i,rewards,banker) 
	logError(win_type,who_win,i,json.encode(rewards),banker)
...
return mahjong_action_small_reward_89