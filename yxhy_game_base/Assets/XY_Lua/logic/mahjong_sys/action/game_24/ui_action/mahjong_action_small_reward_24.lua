...
local mahjong_action_small_reward_24 = class("mahjong_action_small_reward_24", base)
  

  function mahjong_action_small_reward_24:GetScoreItem(rewards,win_type,win_viewSeat,viewSeat, i, who_win,basescore,bGangAddNoWin,banker)
	local scoreItem = {}
...
return mahjong_action_small_reward_24
