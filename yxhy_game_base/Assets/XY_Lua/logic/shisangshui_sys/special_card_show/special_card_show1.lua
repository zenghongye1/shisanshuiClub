...
function this.Show(cards, nSpecialType,viewSeat,show_time)
	...
	if this.gameObject==nil then
		...
		this.gameObject=newNormalUI(data_center.GetResRootPath().."/ui/special_card_show")
	else
...
---[[
	...
	animations_sys.PlayAnimation(animalPar,data_center.GetResRootPath().."/effects/special_card_type",SpecialAnimalName[nSpecialType],100,100,false, callback)
	--]]
