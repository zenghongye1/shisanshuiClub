...
function class_extern(classname, super)
...
function handlerWithOneParam(target, method, arg)
    return function() return method(target, arg) end
end
function handlerWithTwoParam(target, method, arg_one, arg_two)

    return function() return method(target, arg_one, arg_two) end
end
function handlerWithThreeParam(target, method, arg_one, arg_two, arg_three)

    return function() return method(target, arg_one, arg_two, arg_three) end
end
