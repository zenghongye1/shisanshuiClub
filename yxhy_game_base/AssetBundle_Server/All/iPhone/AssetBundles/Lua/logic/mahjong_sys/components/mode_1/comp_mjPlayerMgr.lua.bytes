...
function  comp_mjPlayerMgr:ctor(playerPath)
	playerPath = playerPath or "logic/mahjong_sys/components/mode_1/comp_mjPlayer"
	self.name = "comp_playerMgr"

    self.comp_player_class = require(playerPath)
    self.comp_selfPlayer_class = require("logic/mahjong_sys/components/mode_1/comp_mjSelfPlayer")
